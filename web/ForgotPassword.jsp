<%-- 
    ...
    Created on : 2 May, 2016, 3:27:08 PM
    Author     : Tanya
--%>
...
<header id="header">
    ...
    <div class="row">  
                <div class="single-top-feature">
                    ...
                    <h2 style=" text-align: center; color:black;  ">YOUR QUERY </h2>
                     <h2 style="text-align: center; color:black">IS REPORTED</h2>
                  
                  
                      <h2 style=" text-align: center; color:black;  ">You will soon get a mail with your password mail on your Email </h2>
                       <h2 style=" text-align: center; color:black;  ">You can then login with the password </h2>
                          <BR>
                      <BR>
                      <form action="index.jsp" method="post">
                           <button style="font-size:20px" type="submit">YOU CAN CONTINUE YOUR SEARCH</button>
                           <BR>
                           <BR>
