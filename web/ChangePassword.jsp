      ...
      <div class="menu_area">
       ...
       <div class="row">  
                <div class="single-top-feature">
                        ...
                        <form style="border-color:black;" action="ChangePasswordServlet" > 
                            <center>
                            <table>  
                               
                          
                                <tr>   <td style="font-size: 25px;">EMAIL</td> <td>&nbsp; <input type="email" name="user_email" required> </td> </tr>
            
        <tr> <td style="font-size: 25px;">PASSWORD</td><td>&nbsp;            
            <input type="password" name="user_password" ></td> </tr><br> 
                            
                            <br>
                        
                            <tr>      <td>  <button style=" width:160px;height:51.42;" type="submit">Change Password</button> 
                                    &nbsp; &nbsp; &nbsp; </td>
                            </tr>
