<%-- 
    Document   : AboutHosp
    Created on : 22 Mar, 2016, 1:08:12 AM
    Author     : Tanya
--%>
      ...
      <div class="menu_area">
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">  
         ...
         <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
          ...
          <li><a href="contact.jsp"><span>CONTACTUS</span></a></li>
            ...
            <li><a href="WorkplaceProfile.jsp">PROFILE</a></li>
       ...
       <div class="row">  
          ...
          <h1><a href="index.jsp"><span></span> <small style="color:blue;"></small></a></h1>
                     ...
                     <br>
                     <form action="SpecDoctors.jsp" method="post">
                          <input type="hidden" name="workplace_id" value="<%=workplaceid%>">
                     <button style="font-size:25px" type="submit">SPECIALISED DOCTORS</button>
                     </form>
