<%-- 
    Document   : UpdateWorkplace
    Created on : 19 May, 2016, 7:18:22 PM
    Author     : Tanya
--%>
        ...
        <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
          ...
          <li><a href="contact.jsp"><span>CONTACTUS</span></a></li>
             ...
             <li><a href="Feedback.jsp">FEEDBACK</a></li>
              ...
              <li><a href="WorkplaceProfile.jsp"><span>PROFILE </span></a></li>
                    ...
                    <h2 style=" text-align: center; color:lightblueblue;  ">YOU HAVE </h2>
                     <h2 style="text-align: center; color:lightblueblue">SUCCESSFULLY </h2>
                      ...
                      <form action="index1.jsp" method="post">
                           <button style="font-size:25px" type="submit">YOU CAN NOW SUCCESSFULLY LOGOUT!!</button>
                           <BR>
                           <BR>
