<%-- 
    Document   : aboutus
    Created on : 18 Mar, 2016, 2:13:54 AM
    Author     : Tanya
--%>
...
<header id="header">
    ...
    margin-right:35%;">
                    ...
                    <tr style="border: 1px black;">
                        <td style="border: 2px solid black;"><a href="Mission.jsp" style="display: inline-block; width: 200px; height: 100px; background-color:rgb(255, 209, 51);text-align:center;"><h2>MISSION</h2></a></td>
                        <td style="border: 2px solid black;"><a href="Vision.jsp" style="display: inline-block; width: 200px; height: 100px; background-color: rgb(0, 0, 0); text-align: center; "><h2>VISION</h2></a></td>
                    </TR>
                    <TR style="border: 1px solid black;">
                        <td style="border: 2px solid black;"><a href="TermsOfUse.jsp"style="display: inline-block; width: 200px; height: 100px; background-color:rgb(0, 0, 0); text-align: center;color:rgb(255, 209, 51);color:rgb(255, 209, 51) "><h2>TERMS OF USE</h2></a></td>
                        <td style="border: 2px solid black;"><a href="PrivacyPolicy.jsp"style="display: inline-block; width: 200px; height: 100px; background-color: rgb(255, 209, 51); text-align: center;"><h2>PRIVACY POLICY</h2></a></td>
                    </tr>
