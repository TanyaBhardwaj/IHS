       ...
       <div class="row">  
          ...
          <ul class="sb_menu">
            ...
            <li><a href=""></a></li>
                ...
                <table>
                    <tr>
                        <td> <h2> <span>ABOUT IHS: </span> </h2> </td>
                        
                    </tr>
                    <tr>
                        <td><a href="" style="display: inline-block; width: 230px; height: 100px; background-color:lightskyblue; text-align: center;"><h2>MISION</h2></a></td>
                        <td><a href="" style="display: inline-block; width: 230px; height: 100px; background-color: lightcoral; text-align: center;"><h2>VISION</h2></a></td>
                    </TR>
                    <br>
                    <TR>
                        <td><a href=""style="display: inline-block; width: 230px; height: 100px; background-color:  lightsalmon; text-align: center;"><h2>TERMS OF USE</h2></a></td>
                        <td><a href=""style="display: inline-block; width: 230px; height: 100px; background-color:lightgreen ; text-align: center;"><h2>PRIVACY POLICY</h2></a></td>
                    </tr>
                </table> 
       </div>
       </div>
