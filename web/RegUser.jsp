<%-- 
    Document   : RegUser
    Created on : 14 Mar, 2016, 1:55:54 PM
    Author     : Tanya
--%>
...
<header id="header">
    ...
    <div class="row">  
          ...
          <h1><a href="index.jsp"><span></span> <small style="color:blue;"></small></a></h1>
            ...
            <center>
                <br>
                <br> 
                <form  id="RegUser" action="RegUser.jsp" method="post"> </form>
                 <form  id="RegUserServlet" action="RegUser" method="post">  
  ...
  <tr>
      ...
      <td><input type="text" name="RecoveryEmail" required ><br></br></td>
  </tr>
   ...
   <br>
                     ...
                     <button  type="submit">SUBMIT</button> 
                      ...
                      <button  type="submit" form="RegUser">CANCEL</button> 
