...
<header id="header">
     ...
     <div class="row">  
          ...
          <h1><a href="index.jsp"><span></span> <small style="color:blue;"></small></a></h1>
            ...
            <center> 
                <br>
      <form id="RegHLC" action="RegHLC.jsp" method="post"> </form>
                 <form id="RegHLCServlet" action="RegWorkplace" method="post">  
       <table>
           
          
           <tr>
               <th> NAME:&nbsp;&nbsp;</th>
               <td><input type="text" name="workname" required><br><br></td>
           </tr>
           
           <tr>
               <th>TYPE:</th>
               <td> <select name="Wtype" required>
           ...
           <td> <input type="text" name="specialization" required><br><br></td>
           <br> </tr>
           <br>   <tr>
               <th>EMAIL: &nbsp;</th>
   ...
   <button type="reset" action="RegHLC.jsp">CANCEL</button>
</form>   
      <br>  </center>
                </div>
     </div>
