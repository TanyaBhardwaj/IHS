...
<header id="header">
  ...
  <tr>
      ...
      <td><input type="text" name="complaint" required><br></br></td>
  </tr>
  <tr>
      <th>ANY RECOMMENDATIONS?</th>
      <td><input type="text" name="recommendation" required><br><br></td>
  </tr>
  <tr>
      <th>RATE OUR WEBSITE:</th>
      <td><input type="text" name="rate" required><br><br></td>
   </tr>
   <br>
   <br>
   </table>
